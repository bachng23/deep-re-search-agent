...
For each conflict:
    ...
    - Copy a VERBATIM sentence from each side's abstract as evidence ('position_a_quote', 'position_b_quote') - exact text, no paraphrasing.
...
Rules:
    ...
    - Every quote MUST appear in the provided abstracts. If you cannot quote both sides, do not report the conflict.
